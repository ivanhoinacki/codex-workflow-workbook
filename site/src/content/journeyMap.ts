...
export const journeyDefinitions: JourneyDefinition[] = [
        ...
        pages: [
          ...
          page(
            ...
            choice(
              ...
              ['Runtime and tooling', 'Markdown content', 'The published website'],
              'Runtime and tooling',
          ...
          page(
            ...
            choice(
              ...
              [
                ...
                'Before reading the conceptual chapters',
  ...
  },
  {
    ...
    description: 'Runtime configuration, rules, subagents, hooks, MCPs and skills.',
      ...
      },
      {
        ...
        pages: [
          page(
            ...
            'Subagents',
            '07-agents.md',
            'I can decide when to delegate to a subagent and when a simple local read is enough.',
            choice(
              'subagents-use',
              'When do subagents make the most sense?',
              ['For every simple question', 'For concrete and bounded fan-out', 'To ignore the main plan'],
              'For concrete and bounded fan-out',
              'Subagents help when there is real parallelism and a well-defined scope.',
            ),
            ['Subagents'],
          ),
          page(
          ...
          page(
            ...
            choice(
              ...
              [
                'They provide context, evidence, authentication or synchronization',
          ...
          page(
            ...
            'I can test whether rules, subagents, hooks and skills appear in the local workflow.',
            choice(
              'hands-on-reflection',
    ...
    chapters: [
      {
        ...
        pages: [
          page(
            ...
            'Token Economy',
            '10-token-economy.md',
            'I can explain how to use long context intentionally without filling the thread with noise.',
            choice(
              'token-economy-mechanism',
              'What is the healthiest way to think about token economy?',
              ['Always keep prompts short', 'Use context intentionally and keep noisy output bounded', 'Paste every file into the prompt'],
              'Use context intentionally and keep noisy output bounded',
              'Long threads can be useful. The goal is to keep valuable context visible and avoid irrelevant output.',
            ),
            ['Knowledge'],
          ),
          page(
            ...
            'I can distinguish chat history, Session-Memory, vault docs and indexed knowledge.',
            choice(
              'memory-when',
              'What is Session-Memory for?',
              ['A concise handoff for future sessions', 'A full copy of the chat history', 'A place to store secrets'],
              'A concise handoff for future sessions',
              'Session-Memory preserves decisions, pending actions and where to resume. It should not duplicate the whole chat.',
            ),
            ['Memory'],
          ),
        ],
        ...
        pages: [
          page(
            ...
            choice(
              ...
              'Validate the environment on a small and safe request',
              'The guided first task observes rules, hooks, skills, subagents and MCPs without creating external risk.',
            ),
            ['Practice', 'Validation'],
          ),
        ],
